...
\include{part1_foundations_cosmic}
\include{part2_nested_hierarchy}
\include{part3_cosmological_collapse}
\include{part4_mathematics_cosmic}
\include{part5_empirical_cosmic}
\include{part6_objections}

% ------------------------
% Appendices
% ------------------------
\appendix
\include{appendix_a_mathematical}
\include{appendix_b_protocols}
\include{appendix_c_constants}
\include{appendix_d_glossary}
\include{appendix_e_physics_correspondence}
