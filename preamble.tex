...
% Typography
% ------------------------
% \usepackage{lmodern}           % Latin Modern fonts (not available)
\usepackage[expansion=false]{microtype}  % Improved typography (expansion disabled)
...
% Bibliography
% ------------------------
% Using natbib instead of biblatex (not available)
\usepackage[numbers,sort&compress]{natbib}
\bibliographystyle{plainnat}
% Define autocite for compatibility with biblatex syntax
\newcommand{\autocite}{\cite}
% Note: Will use \bibliography{bibliography} in main.tex instead of printbibliography
