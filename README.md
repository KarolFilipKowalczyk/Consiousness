...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.17556941.svg)](https://doi.org/10.5281/zenodo.17556941)
...
- Variable gap function `f(n) ≥ 1` explains:
  - **Small gaps** (f ≈ 1-2): Incremental, analytical processing
  - **Large gaps** (f ≫ 1): Gestalt insights, "aha!" moments
- Universality condition: `lim(n→∞) f(n) = ∞` ensures asymptotic universality

### 2. **Temporal Collapse Mechanism**
- Distinguishes **computational time** (includes all explorations) from **subjective time** (collapsed path only)
- Explains temporal phenomenology: why consciousness feels unified and forward-flowing
- Connects to memory consolidation: failed attempts never enter accessible memory

### 3. **Resolution of Hard Problem**
- Consciousness IS collapsed computation experienced from within
- No explanatory gap: the computational structure itself is necessarily experiential
- Dissolves dualism through identity, not production relation

### 4. **Non-Computable Selector**
- Resource allocation follows non-computable optimization (related to Kolmogorov complexity)
- Provides natural account of agency and free will
- Genuine top-down causation without violating physical law

### 5. **Integration of Existing Theories**
- **IIT**: Integration within each machine level (Φ > Φ_min required)
- **GWT**: Global workspace = post-collapse broadcasting mechanism
...
### Part I: Foundations
- Machine hierarchy definition with non-uniform structure
- Selector problem and non-computability
- Collapse events as resource reallocation

### Part II: Existing Theories
- Detailed comparison with IIT, GWT, AST, Orch-OR
- Shows how each captures one aspect of complete picture

### Part III: Temporal Revolution
...
### Appendices
- Mathematical formalization (formal definitions, theorems, proofs)
...
```
τ_n ≈ 2^n · τ₀ where τ₀ ≈ 50ms
Integration window grows exponentially with level
```
...
1. Disorders involve hierarchy disruption or collapse failure
2. Attention deficits reflect selector malfunction
3. Altered states show abnormal gap dynamics
...
@article{kowalczyk2025consciousness,
  title={Consciousness as Collapsed Computational Time: A Unified Theory Integrating Finite Machine Hierarchies},
...
- Watch for new releases and revisions
